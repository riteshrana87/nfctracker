...
<div id="page-wrapper">
    <div class="main-page">
        ...
        <div class="row">
            <form action="<?=base_url('Medical/insert_mac')?>" method="post" id="doform" name="doform" data-parsley-validate enctype="multipart/form-data">
                    <div class="col-sm-12">
                        <div class="">
                            <h1 class="page-title">EDIT MEDICAL CONSENTS</h1>
                        </div>
                    </div>
