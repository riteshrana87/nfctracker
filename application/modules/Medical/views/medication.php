            ...
            <div class="col-xs-12">
                ...
                <div class="panel panel-default tile tile-profile m-t-10">
                    <div class="panel-body min-h-310">
                        ...
                        <form action="<?=base_url('Medical/insert_medication')?>" method="post" id="doform" name    ="doform" data-parsley-validate enctype="multipart/form-data">
                        ...
                        if(!empty($form_data))
                        {
                         ...
                         ?>
                             ...
                             <div class="col-sm-12">
                                    ...
                                    <button type="submit" class="btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default">Add New Medication</button>
