                    ...
                    <div class="col-sm-12">
                     ...
                     <div class="col-sm-12">
                        ...
                        <input type="hidden" name="do_id" id="do_id" value="<?=!empty($do_id)?$do_id:''?>">
                             ...
                             <a href="<?=base_url('DailyObservation/view/'.$do_id)?>" class="btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default">View Daily Observation</a>
                            <a href="<?=base_url()?>" class="pull-right btn btn-default" name="submit_ppform" id="submit_ppform" value="submit" style="default">Return to Crisis Dashboard</a>
