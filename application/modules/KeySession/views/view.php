                    ...
                    <div class="pull-right">
                        <div class="btn-group">
                            ...
                            <a href="<?=base_url('KeySession/index/'.$ypid); ?>" class="btn btn-default">
                                     <i class="fa fa-mail-reply"></i> Key Session
                                </a>
                                                ...
                                                foreach ($imgs as $img) {
                                                    ?>
                                                        <div class="col-sm-1 margin-bottom">
                                                                   <?php 
                                                                    if(@is_array(getimagesize($this->config->item ('ks_img_base_url').$ypid.'/'.$img))){
                                                                           ?>
                                                                           <img width="100" height="100" src="<?=$this->config->item ('ks_img_base_url_small').$ypid.'/'.$img?>">
                                                                           <?php
                                                                        } else {
                                                                            ?>
