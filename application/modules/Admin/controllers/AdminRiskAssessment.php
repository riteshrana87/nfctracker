...
class AdminRiskAssessment extends CI_Controller {
    ...
    public function insertModule() {
        ...
        // pr($jsonData); exit;
        $fields = array(
            'risk_assesment_id' => array('type' => 'INT', 'constraint' => 5, 'unsigned' => TRUE, 'auto_increment' => TRUE),'yp_id' => array('type' => 'INT', 'constraint' => 5, 'unsigned' => TRUE));
    ...
    public function updateModule() {
        ...
        $fields_data = array('risk_assesment_id','yp_id');
        ...
        //$diff_data = array_merge(array_diff($delete, $val_data), array_diff($val_data, $delete));
       ...
       /* $delete_fields = $this->input->post('field_data');
        ...
        foreach($field_delete as $val){
            if($this->db->field_exists($val, 'risk_assessment')){
                $this->dbforge->drop_column('risk_assessment', $val);
            }    
       }
       */
