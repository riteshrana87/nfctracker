...
class AdminIndividualBehaviourPlan extends CI_Controller {
    ...
    public function insertModule() {
        ...
        // pr($jsonData); exit;
        $fields = array(
            'ibp_id' => array('type' => 'INT', 'constraint' => 5, 'unsigned' => TRUE, 'auto_increment' => TRUE),'yp_id' => array('type' => 'INT', 'constraint' => 5, 'unsigned' => TRUE));
    ...
    public function updateModule() {
        ...
        $fields_data = array('ibp_id','yp_id');
        ...
        foreach($field_delete as $val){
            if($this->db->field_exists($val, 'individual_behaviour_plan')){
