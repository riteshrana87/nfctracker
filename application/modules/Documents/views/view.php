                                        ...
                                        foreach ($imgs as $img) {
                                            ?>
                                                <div class="col-sm-1 margin-bottom">
                                                           <?php 
                                                            if(@is_array(getimagesize($this->config->item ('docs_img_base_url').$ypid.'/'.$img))){
                                                                   ?>
                                                                   <a href="<?php echo base_url($crnt_view.'/download/'.$edit_data[0]['docs_id'].'/'.$ypid);?>" class="btn btn-link btn-blue">
                                                                   <img width="100" height="100" src="<?=$this->config->item ('docs_img_base_url_small').$ypid.'/'.$img?>"></a>
                                                                   <?php
                                                                } else {
                                                                    ?>
                                                                     <a href="<?php echo base_url($crnt_view.'/download/'.$edit_data[0]['docs_id'].'/'.$ypid);?>" class="btn btn-link btn-blue">
