                      ...
                      <div class="clearfix"></div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <?php if($disable ==""){?>
                                        <input class="form-control" name="position" id="position" placeholder="Enter Position" type="text" value="<?PHP if($formAction == "registration"){ echo set_value('Position');?><?php }else{?><?=!empty($editRecord[0]['position'])?$editRecord[0]['position']:''?><?php }?>" maxlength="25" required="" <?php echo $disable; ?> />
                                    <?php }else{?>
